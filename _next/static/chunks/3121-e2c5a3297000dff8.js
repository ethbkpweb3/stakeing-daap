(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[3121], {
    58171: function(t, i, r) {
        !function(t, i) {
            "use strict";
            function n(t, i) {
                if (!t)
                    throw Error(i || "Assertion failed")
            }
            function h(t, i) {
                t.super_ = i;
                var r = function() {};
            ...
            e.wordSize = 26;
            try {
                m = "undefined" != typeof window && void 0 !== window.Buffer ? window.Buffer : r(46601).Buffer
            } catch (t) {}
            function o(t, i) {
            ...
            e.prototype._initArray = function(t, i, r) {
                ...
                for (var h, e, o = 0; o < this.length; o++)
                    this.words[o] = 0;
                var s = 0;
                if ("be" === r)
                    for (o = t.length - 1,
                    h = 0; o >= 0; o -= 3)
                        ...
                        this.words[h] |= e << s & 67108863,
                        this.words[h + 1] = e >>> 26 - s & 67108863,
                        (s += 24) >= 26 && (s -= 26,
                        h++);
                else if ("le" === r)
                    for (o = 0,
            ...
            e.prototype._parseHex = function(t, i, r) {
                ...
                if ("be" === r)
                    for (h = t.length - 1; h >= i; h -= 2)
                        ...
                        e >= 18 ? (e -= 18,
                        o += 1,
                        this.words[o] |= n >>> 26) : e += 8;
                else
                    for (h = (t.length - i) % 2 == 0 ? i + 1 : i; h < t.length; h += 2)
                        n = s(t, i, h) << e,
                        this.words[o] |= 67108863 & n,
                        e >= 18 ? (e -= 18,
                        o += 1,
            ...
            e.prototype._parseBase = function(t, i, r) {
                ...
                n--,
                h = h / i | 0;
                for (var e = t.length - r, o = e % n, s = Math.min(e, e - o) + r, a = 0, l = r; l < s; l += n)
                    a = u(t, l, l + n, i),
                    this.imuln(h),
                    this.words[0] + a < 67108864 ? this.words[0] += a : this._iaddn(a);
                if (0 !== o) {
                    var m = 1;
                    for (a = u(t, l, t.length, i),
                    l = 0; l < o; l++)
                        m *= i;
                    this.imuln(m),
                    this.words[0] + a < 67108864 ? this.words[0] += a : this._iaddn(a)
            ...
            e.prototype.toString = function(t, i) {
                ...
                16 === (t = t || 10) || "hex" === t) {
                    r = "";
                    for (var r, h = 0, e = 0, o = 0; o < this.length; o++) {
                        var s = this.words[o]
                          , u = ((s << h | e) & 16777215).toString(16);
                        e = s >>> 24 - h & 16777215,
                        (h += 2) >= 26 && (h -= 26,
                        o--),
            ...
            e.prototype.setn = function(t, i) {
                ...
                i ? this.words[r] = this.words[r] | 1 << h : this.words[r] = this.words[r] & ~(1 << h),
                this._strip()
            }
            ,
            e.prototype.iadd = function(t) {
                ...
                n = t) : (r = t,
                n = this);
                for (var i, r, n, h = 0, e = 0; e < n.length; e++)
            ...
            e.prototype.isub = function(t) {
                ...
                for (var e = 0, o = 0; o < r.length; o++)
                    e = (n = (0 | i.words[o]) - (0 | r.words[o]) + e) >> 26,
                    this.words[o] = 67108863 & n;
                for (; 0 !== e && o < i.length; o++)
                    e = (n = (0 | i.words[o]) + e) >> 26,
                    this.words[o] = 67108863 & n;
            ...
            var v = function(t, i, r) {
                var n, h, e, o = t.words, s = i.words, u = r.words, a = 0, l = 0 | o[0], m = 8191 & l, f = l >>> 13, d = 0 | o[1], p = 8191 & d, M = d >>> 13, v = 0 | o[2], g = 8191 & v, c = v >>> 13, w = 0 | o[3], y = 8191 & w, b = w >>> 13, _ = 0 | o[4], k = 8191 & _, A = _ >>> 13, S = 0 | o[5], x = 8191 & S, B = S >>> 13, R = 0 | o[6], q = 8191 & R, Z = R >>> 13, L = 0 | o[7], N = 8191 & L, E = L >>> 13, I = 0 | o[8], T = 8191 & I, z = I >>> 13, O = 0 | o[9], j = 8191 & O, U = O >>> 13, C = 0 | s[0], K = 8191 & C, P = C >>> 13, F = 0 | s[1], D = 8191 & F, H = F >>> 13, J = 0 | s[2], G = 8191 & J, Q = J >>> 13, V = 0 | s[3], W = 8191 & V, X = V >>> 13, Y = 0 | s[4], $ = 8191 & Y, tt = Y >>> 13, ti = 0 | s[5], tr = 8191 & ti, tn = ti >>> 13, th = 0 | s[6], te = 8191 & th, to = th >>> 13, ts = 0 | s[7], tu = 8191 & ts, ta = ts >>> 13, tl = 0 | s[8], tm = 8191 & tl, tf = tl >>> 13, td = 0 | s[9], tp = 8191 & td, tM = td >>> 13;
                r.negative = t.negative ^ i.negative,
                r.length = 19;
                var tv = (a + (n = Math.imul(m, K)) | 0) + ((8191 & (h = (h = Math.imul(m, P)) + Math.imul(f, K) | 0)) << 13) | 0;
                a = ((e = Math.imul(f, P)) + (h >>> 13) | 0) + (tv >>> 26) | 0,
                tv &= 67108863,
                n = Math.imul(p, K),
                h = (h = Math.imul(p, P)) + Math.imul(M, K) | 0,
                e = Math.imul(M, P);
                var tg = (a + (n = n + Math.imul(m, D) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, H) | 0) + Math.imul(f, D) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, H) | 0) + (h >>> 13) | 0) + (tg >>> 26) | 0,
                tg &= 67108863,
                n = Math.imul(g, K),
                h = (h = Math.imul(g, P)) + Math.imul(c, K) | 0,
                e = Math.imul(c, P),
                n = n + Math.imul(p, D) | 0,
                h = (h = h + Math.imul(p, H) | 0) + Math.imul(M, D) | 0,
                e = e + Math.imul(M, H) | 0;
                var tc = (a + (n = n + Math.imul(m, G) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, Q) | 0) + Math.imul(f, G) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, Q) | 0) + (h >>> 13) | 0) + (tc >>> 26) | 0,
                tc &= 67108863,
                n = Math.imul(y, K),
                h = (h = Math.imul(y, P)) + Math.imul(b, K) | 0,
                e = Math.imul(b, P),
                n = n + Math.imul(g, D) | 0,
                ...
                e = e + Math.imul(M, Q) | 0;
                var tw = (a + (n = n + Math.imul(m, W) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, X) | 0) + Math.imul(f, W) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, X) | 0) + (h >>> 13) | 0) + (tw >>> 26) | 0,
                tw &= 67108863,
                n = Math.imul(k, K),
                h = (h = Math.imul(k, P)) + Math.imul(A, K) | 0,
                e = Math.imul(A, P),
                n = n + Math.imul(y, D) | 0,
                ...
                e = e + Math.imul(M, X) | 0;
                var ty = (a + (n = n + Math.imul(m, $) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, tt) | 0) + Math.imul(f, $) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, tt) | 0) + (h >>> 13) | 0) + (ty >>> 26) | 0,
                ty &= 67108863,
                n = Math.imul(x, K),
                h = (h = Math.imul(x, P)) + Math.imul(B, K) | 0,
                e = Math.imul(B, P),
                n = n + Math.imul(k, D) | 0,
                ...
                var tb = (a + (n = n + Math.imul(m, tr) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, tn) | 0) + Math.imul(f, tr) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, tn) | 0) + (h >>> 13) | 0) + (tb >>> 26) | 0,
                tb &= 67108863,
                n = Math.imul(q, K),
                h = (h = Math.imul(q, P)) + Math.imul(Z, K) | 0,
                e = Math.imul(Z, P),
                n = n + Math.imul(x, D) | 0,
                ...
                h = (h = h + Math.imul(p, tn) | 0) + Math.imul(M, tr) | 0,
                e = e + Math.imul(M, tn) | 0;
                var t_ = (a + (n = n + Math.imul(m, te) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, to) | 0) + Math.imul(f, te) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, to) | 0) + (h >>> 13) | 0) + (t_ >>> 26) | 0,
                t_ &= 67108863,
                n = Math.imul(N, K),
                h = (h = Math.imul(N, P)) + Math.imul(E, K) | 0,
                e = Math.imul(E, P),
                n = n + Math.imul(q, D) | 0,
                ...
                h = (h = h + Math.imul(g, tn) | 0) + Math.imul(c, tr) | 0,
                e = e + Math.imul(c, tn) | 0,
                n = n + Math.imul(p, te) | 0,
                h = (h = h + Math.imul(p, to) | 0) + Math.imul(M, te) | 0,
                e = e + Math.imul(M, to) | 0;
                var tk = (a + (n = n + Math.imul(m, tu) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, ta) | 0) + Math.imul(f, tu) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, ta) | 0) + (h >>> 13) | 0) + (tk >>> 26) | 0,
                tk &= 67108863,
                n = Math.imul(T, K),
                h = (h = Math.imul(T, P)) + Math.imul(z, K) | 0,
                e = Math.imul(z, P),
                n = n + Math.imul(N, D) | 0,
                ...
                h = (h = h + Math.imul(y, tn) | 0) + Math.imul(b, tr) | 0,
                e = e + Math.imul(b, tn) | 0,
                n = n + Math.imul(g, te) | 0,
                h = (h = h + Math.imul(g, to) | 0) + Math.imul(c, te) | 0,
                e = e + Math.imul(c, to) | 0,
                n = n + Math.imul(p, tu) | 0,
                h = (h = h + Math.imul(p, ta) | 0) + Math.imul(M, tu) | 0,
                e = e + Math.imul(M, ta) | 0;
                var tA = (a + (n = n + Math.imul(m, tm) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, tf) | 0) + Math.imul(f, tm) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, tf) | 0) + (h >>> 13) | 0) + (tA >>> 26) | 0,
                tA &= 67108863,
                n = Math.imul(j, K),
                h = (h = Math.imul(j, P)) + Math.imul(U, K) | 0,
                e = Math.imul(U, P),
                n = n + Math.imul(T, D) | 0,
                h = (h = h + Math.imul(T, H) | 0) + Math.imul(z, D) | 0,
                e = e + Math.imul(z, H) | 0,
                n = n + Math.imul(N, G) | 0,
                ...
                h = (h = h + Math.imul(k, tn) | 0) + Math.imul(A, tr) | 0,
                e = e + Math.imul(A, tn) | 0,
                n = n + Math.imul(y, te) | 0,
                h = (h = h + Math.imul(y, to) | 0) + Math.imul(b, te) | 0,
                e = e + Math.imul(b, to) | 0,
                n = n + Math.imul(g, tu) | 0,
                h = (h = h + Math.imul(g, ta) | 0) + Math.imul(c, tu) | 0,
                e = e + Math.imul(c, ta) | 0,
                n = n + Math.imul(p, tm) | 0,
                h = (h = h + Math.imul(p, tf) | 0) + Math.imul(M, tm) | 0,
                e = e + Math.imul(M, tf) | 0;
                var tS = (a + (n = n + Math.imul(m, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(m, tM) | 0) + Math.imul(f, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(f, tM) | 0) + (h >>> 13) | 0) + (tS >>> 26) | 0,
                tS &= 67108863,
                n = Math.imul(j, D),
                h = (h = Math.imul(j, H)) + Math.imul(U, D) | 0,
                e = Math.imul(U, H),
                n = n + Math.imul(T, G) | 0,
                h = (h = h + Math.imul(T, Q) | 0) + Math.imul(z, G) | 0,
                e = e + Math.imul(z, Q) | 0,
                n = n + Math.imul(N, W) | 0,
                ...
                h = (h = h + Math.imul(x, tn) | 0) + Math.imul(B, tr) | 0,
                e = e + Math.imul(B, tn) | 0,
                n = n + Math.imul(k, te) | 0,
                h = (h = h + Math.imul(k, to) | 0) + Math.imul(A, te) | 0,
                e = e + Math.imul(A, to) | 0,
                n = n + Math.imul(y, tu) | 0,
                h = (h = h + Math.imul(y, ta) | 0) + Math.imul(b, tu) | 0,
                e = e + Math.imul(b, ta) | 0,
                n = n + Math.imul(g, tm) | 0,
                h = (h = h + Math.imul(g, tf) | 0) + Math.imul(c, tm) | 0,
                e = e + Math.imul(c, tf) | 0;
                var tx = (a + (n = n + Math.imul(p, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(p, tM) | 0) + Math.imul(M, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(M, tM) | 0) + (h >>> 13) | 0) + (tx >>> 26) | 0,
                tx &= 67108863,
                n = Math.imul(j, G),
                h = (h = Math.imul(j, Q)) + Math.imul(U, G) | 0,
                e = Math.imul(U, Q),
                n = n + Math.imul(T, W) | 0,
                h = (h = h + Math.imul(T, X) | 0) + Math.imul(z, W) | 0,
                e = e + Math.imul(z, X) | 0,
                n = n + Math.imul(N, $) | 0,
                h = (h = h + Math.imul(N, tt) | 0) + Math.imul(E, $) | 0,
                e = e + Math.imul(E, tt) | 0,
                n = n + Math.imul(q, tr) | 0,
                h = (h = h + Math.imul(q, tn) | 0) + Math.imul(Z, tr) | 0,
                e = e + Math.imul(Z, tn) | 0,
                n = n + Math.imul(x, te) | 0,
                h = (h = h + Math.imul(x, to) | 0) + Math.imul(B, te) | 0,
                e = e + Math.imul(B, to) | 0,
                n = n + Math.imul(k, tu) | 0,
                h = (h = h + Math.imul(k, ta) | 0) + Math.imul(A, tu) | 0,
                e = e + Math.imul(A, ta) | 0,
                n = n + Math.imul(y, tm) | 0,
                h = (h = h + Math.imul(y, tf) | 0) + Math.imul(b, tm) | 0,
                e = e + Math.imul(b, tf) | 0;
                var tB = (a + (n = n + Math.imul(g, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(g, tM) | 0) + Math.imul(c, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(c, tM) | 0) + (h >>> 13) | 0) + (tB >>> 26) | 0,
                tB &= 67108863,
                n = Math.imul(j, W),
                h = (h = Math.imul(j, X)) + Math.imul(U, W) | 0,
                e = Math.imul(U, X),
                n = n + Math.imul(T, $) | 0,
                h = (h = h + Math.imul(T, tt) | 0) + Math.imul(z, $) | 0,
                e = e + Math.imul(z, tt) | 0,
                n = n + Math.imul(N, tr) | 0,
                h = (h = h + Math.imul(N, tn) | 0) + Math.imul(E, tr) | 0,
                e = e + Math.imul(E, tn) | 0,
                n = n + Math.imul(q, te) | 0,
                h = (h = h + Math.imul(q, to) | 0) + Math.imul(Z, te) | 0,
                e = e + Math.imul(Z, to) | 0,
                n = n + Math.imul(x, tu) | 0,
                h = (h = h + Math.imul(x, ta) | 0) + Math.imul(B, tu) | 0,
                e = e + Math.imul(B, ta) | 0,
                n = n + Math.imul(k, tm) | 0,
                h = (h = h + Math.imul(k, tf) | 0) + Math.imul(A, tm) | 0,
                e = e + Math.imul(A, tf) | 0;
                var tR = (a + (n = n + Math.imul(y, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(y, tM) | 0) + Math.imul(b, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(b, tM) | 0) + (h >>> 13) | 0) + (tR >>> 26) | 0,
                tR &= 67108863,
                n = Math.imul(j, $),
                h = (h = Math.imul(j, tt)) + Math.imul(U, $) | 0,
                e = Math.imul(U, tt),
                n = n + Math.imul(T, tr) | 0,
                h = (h = h + Math.imul(T, tn) | 0) + Math.imul(z, tr) | 0,
                e = e + Math.imul(z, tn) | 0,
                n = n + Math.imul(N, te) | 0,
                h = (h = h + Math.imul(N, to) | 0) + Math.imul(E, te) | 0,
                e = e + Math.imul(E, to) | 0,
                n = n + Math.imul(q, tu) | 0,
                h = (h = h + Math.imul(q, ta) | 0) + Math.imul(Z, tu) | 0,
                e = e + Math.imul(Z, ta) | 0,
                n = n + Math.imul(x, tm) | 0,
                h = (h = h + Math.imul(x, tf) | 0) + Math.imul(B, tm) | 0,
                e = e + Math.imul(B, tf) | 0;
                var tq = (a + (n = n + Math.imul(k, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(k, tM) | 0) + Math.imul(A, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(A, tM) | 0) + (h >>> 13) | 0) + (tq >>> 26) | 0,
                tq &= 67108863,
                n = Math.imul(j, tr),
                h = (h = Math.imul(j, tn)) + Math.imul(U, tr) | 0,
                e = Math.imul(U, tn),
                n = n + Math.imul(T, te) | 0,
                h = (h = h + Math.imul(T, to) | 0) + Math.imul(z, te) | 0,
                e = e + Math.imul(z, to) | 0,
                n = n + Math.imul(N, tu) | 0,
                h = (h = h + Math.imul(N, ta) | 0) + Math.imul(E, tu) | 0,
                e = e + Math.imul(E, ta) | 0,
                n = n + Math.imul(q, tm) | 0,
                h = (h = h + Math.imul(q, tf) | 0) + Math.imul(Z, tm) | 0,
                e = e + Math.imul(Z, tf) | 0;
                var tZ = (a + (n = n + Math.imul(x, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(x, tM) | 0) + Math.imul(B, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(B, tM) | 0) + (h >>> 13) | 0) + (tZ >>> 26) | 0,
                tZ &= 67108863,
                n = Math.imul(j, te),
                h = (h = Math.imul(j, to)) + Math.imul(U, te) | 0,
                e = Math.imul(U, to),
                n = n + Math.imul(T, tu) | 0,
                h = (h = h + Math.imul(T, ta) | 0) + Math.imul(z, tu) | 0,
                e = e + Math.imul(z, ta) | 0,
                n = n + Math.imul(N, tm) | 0,
                h = (h = h + Math.imul(N, tf) | 0) + Math.imul(E, tm) | 0,
                e = e + Math.imul(E, tf) | 0;
                var tL = (a + (n = n + Math.imul(q, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(q, tM) | 0) + Math.imul(Z, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(Z, tM) | 0) + (h >>> 13) | 0) + (tL >>> 26) | 0,
                tL &= 67108863,
                n = Math.imul(j, tu),
                h = (h = Math.imul(j, ta)) + Math.imul(U, tu) | 0,
                e = Math.imul(U, ta),
                n = n + Math.imul(T, tm) | 0,
                h = (h = h + Math.imul(T, tf) | 0) + Math.imul(z, tm) | 0,
                e = e + Math.imul(z, tf) | 0;
                var tN = (a + (n = n + Math.imul(N, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(N, tM) | 0) + Math.imul(E, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(E, tM) | 0) + (h >>> 13) | 0) + (tN >>> 26) | 0,
                tN &= 67108863,
                n = Math.imul(j, tm),
                h = (h = Math.imul(j, tf)) + Math.imul(U, tm) | 0,
                e = Math.imul(U, tf);
                var tE = (a + (n = n + Math.imul(T, tp) | 0) | 0) + ((8191 & (h = (h = h + Math.imul(T, tM) | 0) + Math.imul(z, tp) | 0)) << 13) | 0;
                a = ((e = e + Math.imul(z, tM) | 0) + (h >>> 13) | 0) + (tE >>> 26) | 0,
                tE &= 67108863;
                var tI = (a + (n = Math.imul(j, tp)) | 0) + ((8191 & (h = (h = Math.imul(j, tM)) + Math.imul(U, tp) | 0)) << 13) | 0;
                return a = ((e = Math.imul(U, tM)) + (h >>> 13) | 0) + (tI >>> 26) | 0,
                tI &= 67108863,
                u[0] = tv,
                u[1] = tg,
                u[2] = tc,
            ...
            e.prototype.mulTo = function(t, i) {
                ...
                return 10 === this.length && 10 === t.length ? v(this, t, i) : n < 63 ? M(this, t, i) : g(this, t, i)
            }
            ,
            c.prototype.makeRBT = function(t) {
                for (var i = Array(t), r = e.prototype._countBits(t) - 1, n = 0; n < t; n++)
            ...
            ,
            c.prototype.convert13b = function(t, i, r, h) {
            ...
            e.prototype.mul = function(t) {
                var i = new e(null);
                return i.words = Array(this.length + t.length),
                this.mulTo(t, i)
            }
            ,
            ...
            e.prototype.iushrn = function(t, i, r) {
                n("number" == typeof t && t >= 0),
                h = i ? (i - i % 26) / 26 : 0;
                var h, e = t % 26, o = Math.min((t - e) / 26, this.length), s = 67108863 ^ 67108863 >>> e << e;
                if (h -= o,
                h = Math.max(0, h),
                r) {
                    for (var u = 0; u < o; u++)
                ...
                for (u = this.length - 1; u >= 0 && (0 !== a || u >= h); u--) {
                    ...
                    this.words[u] = a << 26 - e | l >>> e,
                    a = l & s
                }
                return r && 0 !== a && (r.words[r.length++] = a),
            ...
            e.prototype.imaskn = function(t) {
                ...
                this.length <= r) ? this : (0 !== i && r++,
                this.length = Math.min(r, this.length),
                0 !== i && (this.words[this.length - 1] &= 67108863 ^ 67108863 >>> i << i),
                this._strip())
            }
            ,
            ...
            e.prototype._wordDiv = function(t, i) {
                var r, n = this.length - t.length, h = this.clone(), o = t, s = 0 | o.words[o.length - 1];
                0 != (n = 26 - this._countBits(s)) && (o = o.ushln(n),
                h.iushln(n),
                s = 0 | o.words[o.length - 1]);
                var u = h.length - o.length;
                if ("mod" !== i) {
                    (r = new e(null)).length = u + 1,
                    r.words = Array(r.length);
                    for (var a = 0; a < r.length; a++)
                        r.words[a] = 0
                }
                var l = h.clone()._ishlnsubmul(o, 1, u);
                0 === l.negative && (h = l,
                r && (r.words[u] = 1));
                for (var m = u - 1; m >= 0; m--) {
                    var f = (0 | h.words[o.length + m]) * 67108864 + (0 | h.words[o.length + m - 1]);
                    for (f = Math.min(f / s | 0, 67108863),
                    h._ishlnsubmul(o, f, m); 0 !== h.negative; )
                        f--,
                        h.negative = 0,
                        h._ishlnsubmul(o, 1, m),
                        h.isZero() || (h.negative ^= 1);
                    r && (r.words[m] = f)
                }
                return r && r._strip(),
                h._strip(),
                "div" !== i && 0 !== n && h.iushrn(n),
                {
                    div: r || null,
                    mod: h
                }
            ...
            e.prototype.divmod = function(t, i, r) {
                ...
                "mod" !== i && (h = s.div.neg()),
                {
                    div: h,
                    mod: s.mod
                }) : (this.negative & t.negative) != 0 ? (s = this.neg().divmod(t.neg(), i),
                "div" !== i && (o = s.mod.neg(),
            ...
            e.prototype.modrn = function(t) {
                ...
                i && (t = -t),
                n(t <= 67108863);
                for (var r = 67108864 % t, h = 0, e = this.length - 1; e >= 0; e--)
            ...
            e.prototype.egcd = function(t) {
                ...
                for (var l = r.clone(), m = i.clone(); !i.isZero(); ) {
                    for (var f = 0, d = 1; (i.words[0] & d) == 0 && f < 26; ++f,
                    d <<= 1)
                        ;
                    if (f > 0)
                        for (i.iushrn(f); f-- > 0; )
            ...
            e.prototype._invmp = function(t) {
                n(0 === t.negative),
                n(!t.isZero());
                var i, r = this, h = t.clone();
                r = 0 !== r.negative ? r.umod(t) : r.clone();
                for (var o = new e(1), s = new e(0), u = h.clone(); r.cmpn(1) > 0 && h.cmpn(1) > 0; ) {
                    for (var a = 0, l = 1; (r.words[0] & l) == 0 && a < 26; ++a,
                    l <<= 1)
                        ;
                    if (a > 0)
                        for (r.iushrn(a); a-- > 0; )
                            o.isOdd() && o.iadd(u),
                            o.iushrn(1);
                    for (var m = 0, f = 1; (h.words[0] & f) == 0 && m < 26; ++m,
                    f <<= 1)
                        ;
                    if (m > 0)
                        for (h.iushrn(m); m-- > 0; )
                ...
                return 0 > (i = 0 === r.cmpn(1) ? o : s).cmpn(0) && i.iadd(t),
                i
            }
            ,
            ...
            b.prototype.split = function(t, i) {
                ...
                var h = t.words[9];
                for (n = 10,
                i.words[i.length++] = 4194303 & h; n < t.length; n++) {
                    var e = 0 | t.words[n];
            ...
            S.prototype._verify2 = function(t, i) {
                n((t.negative | i.negative) == 0, "red works only with positives"),
            ...
            x.prototype.imul = function(t, i) {
                ...
                var r = t.imul(i)
                  ...
                  , e = h;
                return h.cmp(this.m) >= 0 ? e = h.isub(this.m) : 0 > h.cmpn(0) && (e = h.iadd(this.m)),
                e._forceRed(this)
            }
            ,
            x.prototype.mul = function(t, i) {
                ...
                var r = t.mul(i)
                  ...
                  , h = r.isub(n).iushrn(this.shift)
                  , o = h;
                return h.cmp(this.m) >= 0 ? o = h.isub(this.m) : 0 > h.cmpn(0) && (o = h.iadd(this.m)),
                o._forceRed(this)
            }
            ,
    ...
    10632: function(t, i, r) {
        ...
        h.from && h.alloc && h.allocUnsafe && h.allocUnsafeSlow ? t.exports = n : (e(n, i),
        i.Buffer = o),
        o.prototype = Object.create(h.prototype),
        e(h, o),
        o.from = function(t, i, r) {
            if ("number" == typeof t)
                throw TypeError("Argument must not be a number");
            return h(t, i, r)
        }
        ,
        o.alloc = function(t, i, r) {
            if ("number" != typeof t)
                throw TypeError("Argument must be a number");
            var n = h(t);
            return void 0 !== i ? "string" == typeof r ? n.fill(i, r) : n.fill(i) : n.fill(0),
            n
        }
        ,
